# %%
"""
Analyse av brev om dagpenger juni 2026
"""
...
datasett_sti = "../../data/dagpenger_202606.pkl"
...
tabell
# %%
tabell.to_excel("../../data/tabell_dagpenger_202606.xlsx", index=False)
# %%
_ = df.groupby(["Brevtype", "Antall_ganger", "Tidsbruk"]).agg({"id": "count"})
_.reset_index(inplace=True)
_.to_excel("../../data/tidsbruk_dagpenger_202606.xlsx", index=False)
# %%
